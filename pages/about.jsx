...
import { photos } from "../components/photos/teams";
export default function team() {
  return (
    <div className={styles.team}>
       <Head>
        <title>About Gublootech</title>
        <meta name="description" content="Gubloo Technologies is a one-stop-shop. We are a web design and development company with the expertise to build the next generation of your website." />
      ...
      <div className={"container flex " + styles.our_company}>
        <div className="fb2">
          ...
          <p className="paragraph">
            ...
            management, Gubloo Technologies is a one-stop-shop. We are a web
        ...
        <div className="container flex">
          ...
          <div className="fb2">
            ...
            <p className="paragraph">
              ...
              innovation in every medium, Gubloo Technologies will continue to
      ...
      <div className={"container"}>
        <div className={styles.Gallery}>
          <h2 className="heading" style={{"margin": "10px 0",textAlign:"center"}}> Life at Gubloo</h2>
